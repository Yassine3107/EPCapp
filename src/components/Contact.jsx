    ...
    <ContactPageContainer id="contact">
      ...
      <ContactCardContainer>
        ...
        <ContactCard>
          ...
          <h3>E-mailcontact</h3>
          <p>
            Voor schriftelijke communicatie, stuur een e-mail naar <Email email="info@epc247.be" />. Ons toegewijde team zal snel reageren op uw vragen.
          </p>
        </ContactCard>
        <ContactCard>
        <svg xmlns="http://www.w3.org/2000/svg" height="54px" viewBox="0 0 448 512">
